...
Качественно модель должна воспроизводить три ключевых свойства решения из симуляции:
\begin{enumerate}
...
\begin{figure}[h]
    ...
    \fbox{\parbox{0.85\textwidth}{
        TODO: вставить сравнение симуляции и PINN для \(R=0.20\):
        строки \(\alpha,u,v,p\), столбцы симуляции / PINN / ошибка,
...
\begin{figure}[h]
    \centering
    \fbox{\parbox{0.85\textwidth}{
        TODO: вставить сравнение симуляции и PINN для \(R=0.30\):
        строки \(\alpha,u,v,p\), столбцы симуляции / PINN / ошибка,
        например для \(t=1.5\) и \(t=3.0\).
    }}
...
\begin{figure}[h]
    ...
    \fbox{\parbox{0.85\textwidth}{
        ...
        и, если возможно, скорости всплытия \(v_c(t)\) для симуляции и PINN
